// Transcrypt'ed from Python, 2024-12-18 21:13:12
...
export var fizzbuzz = function (n) {
	for (var i = 0; i < n; i++) {
		if (__mod__ (i, 3) == 0 && __mod__ (i, 5) == 0) {
			print ('fizzbuzz');
		}
		else if (__mod__ (i, 5) == 0) {
			print ('buzz');
		}
		else if (__mod__ (i, 3) == 0) {
			print ('fizz');
		}
		else {
			print (i);
...
//# sourceMappingURL=fizzbuzz_slim.map